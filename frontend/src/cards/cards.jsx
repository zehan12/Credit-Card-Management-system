...
// import { p, useHistory, withRouter } from 'react-router-dom';
...
const Cards = (props) => {
    ...
    const getCard = async () => {
       const res = await fetch("http://localhost:8081/api/cards/"+"639b8fde8b7401524068363a", {
            method: 'GET',
            headers: {
    ...
    const NoCard = () => (
        <>
            <div className={classes.nocard_div}>
                <h1>No cards.</h1>
                <p style={{ textDecoration: "none" }} to='/addcard'>
