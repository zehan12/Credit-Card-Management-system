...
const SignUp = () => {
    ...
    const Success = () => (
        <Dialog className={classes.dialog} open={open}>
            ...
            <a to='/' style={{textDecoration:"none",color:"white"}}><Button style={{width:"100%"}} variant="contained" color="primary">Okay</Button></a>
        </Dialog>
    )
    ...
    return(
        ...
        <Avatar className={classes.avatar}>
            ...
            <a  style={{textDecoration:"none",color:"black"}}  to='/'><Button  variant="contained" size="small">Back</Button></a>
            </div>
            <Success open={open}/>
        </Paper>
        </div>
